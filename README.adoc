...
An Ansible collection for deploying https://agnosticd.github.io/showroom[Showroom] lab instruction environments to OpenShift clusters and VM-based infrastructure.
...
[TIP]
====
**Full documentation**: https://agnosticd.github.io/showroom
