...
|`ocp4_workload_showroom_namespace_display`
|string
|`Showroom Guide`
|Human-friendly display name for the namespace.
...
|string
|`Terminals`
|Display name for the stacked terminals tab.
...
|string
|`Terminal 2`
|Display name for the second terminal tab.
|===
